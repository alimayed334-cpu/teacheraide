...
class _NewAttendanceScreenState extends State<NewAttendanceScreen> with WidgetsBindingObserver {
  ...
  // دالة عرض حوار التعليق
  Future<void> _showCommentDialog(int studentId, String lectureKey, String? currentComment) async {
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                setState(() {
                  _studentComments[studentId] ??= {};
                  _studentComments[studentId]![lectureKey] = commentController.text;
                });
                Navigator.of(context).pop();
              },
            ),
